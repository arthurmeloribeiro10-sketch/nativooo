...
export const Route = createFileRoute("/privacidade")({
  head: () => ({ meta: [{ title: "Privacidade — Apolo" }] }),
  ...
  return (
    <div className="mx-auto w-full max-w-lg px-5 pb-16 pt-6">
      ...
      <div className="mt-4 space-y-4 text-[16px] leading-relaxed text-foreground/85">
        <p>
          O Apolo guarda só o que você registra: refeições, hábitos, passos, sono e suas metas.
        ...
        <p>
          ...
          armazenadas. Perguntas feitas ao Apolo são enviadas ao serviço de IA para gerar a
          resposta.
        </p>
        <p>
